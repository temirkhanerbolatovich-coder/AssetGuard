...
- `build-agent-installer.ps1` — собирает `AssetGuard-Agent-Setup-0.1.5.exe`: мастер установки для передачи на другие Windows-компьютеры;
